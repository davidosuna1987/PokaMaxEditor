<template>
    <div class="steps" id="postcard_create_steps">
        ...
        <div class="steps-content">
          ...
          <div class="step-content">
            <div class="columns m-t-15 p-l-20">
                ...
                <div class="reciever_container">
                    <div class="card">
                        <div class="card-content">
                            <!-- <form id="uplaod_form" v-if="isImportingContacts" class="import-contacts-form" enctype="multipart/form-data">
                              <b-field>
                              ...
                              <div class="add-contacts-to-list" v-if="csv_addresses && csv_addresses.length">
                                <small class="has-text-link is-8 m-t-15"><strong class="has-text-link">Info:</strong> to select this contacts, first you must to add them into {{tempData.sender_data.company}} address list.</small>
                                <div class="level">
                                  <div class="level-left"></div>
                                  <div class="level-right">
                                    <button class="button is-info" :disabled="!checked_csv_addresses.length" @click.prevent="isModalAddressListsActive = true">
                            ...
                            <!-- <form v-else class="reciever_form">
                                <div class="field field-reciever-company">
                                    <input
                                        ...
                                        name="reciever_company"
                                        placeholder="Company"
                                        v-model="tempData.reciever_data.company" />
                                </div>
                                <div class="field field-reciever-birthday">
                                    <input
                                        type="date"
                                        ...
                                        name="reciever_birthday"
                                        placeholder="Birthday"
                                        v-model="tempData.reciever_data.birthday" />
                                </div>
                                <div class="field field-reciever-title">
                                    <input
                                        type="text"
                                        ...
                                        name="reciever_title"
                                        placeholder="Mr"
                                        v-model="tempData.reciever_data.title" />
                                </div>
                                <div class="field field-reciever-name">
                                    <input
                                        type="text"
                                        :class="[{ 'has-error': recieverNameHasError }]"
                                        id="reciever_name"
                                        name="reciever_name"
                                        placeholder="Name *"
                                        v-model="tempData.reciever_data.name" />
                                    <span v-if="recieverNameHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.name'][0]}}
                                        </span>
                                    </span>
                                </div>
                                <div class="field field-reciever-surnames">
                                    <input
                                        type="text"
                                        :class="[{ 'has-error': recieverSurnamesHasError }]"
                                        id="reciever_surnames"
                                        name="reciever_surnames"
                                        placeholder="Surnames *"
                                        v-model="tempData.reciever_data.surnames" />
                                    <span v-if="recieverSurnamesHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.surnames'][0]}}
                                        </span>
                                    </span>
                                </div>
                                <div class="field field-reciever-address-line-1">
                                    <input
                                        type="text"
                                        :class="[{ 'has-error': recieverAddressHasError }]"
                                        id="reciever_address_line_1"
                                        name="reciever_address_line_1"
                                        placeholder="Address line 1 *"
                                        v-model="tempData.reciever_data.address_line_1" />
                                    <span v-if="recieverAddressHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.address_line_1'][0]}}
                                        </span>
                                    </span>
                                </div>
                                <div class="field field-reciever-address-line-2">
                                    <input
                                        ...
                                        name="reciever_address_line_2"
                                        placeholder="Address line 2"
                                        v-model="tempData.reciever_data.address_line_2" />
                                </div>
                                <div class="field field-reciever-city">
                                    <input
                                        type="text"
                                        :class="[{ 'has-error': recieverCityHasError }]"
                                        id="reciever_city"
                                        name="reciever_city"
                                        placeholder="City *"
                                        v-model="tempData.reciever_data.city" />
                                    <span v-if="recieverCityHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.city'][0]}}
                                        </span>
                                    </span>
                                </div>
                                <div class="field field-reciever-country">
                                    <input
                                        type="text"
                                        :class="[{ 'has-error': recieverCountryHasError }]"
                                        id="reciever_country"
                                        name="reciever_country"
                                        placeholder="Country *"
                                        v-model="tempData.reciever_data.country" />
                                    <span v-if="recieverCountryHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.country'][0]}}
                                        </span>
                                    </span>
                                </div>
                                <div class="field field-reciever-zip">
                                    <input
                                        type="number"
                                        :class="[{ 'has-error': recieverZipHasError }]"
                                        id="reciever_zip_code"
                                        name="reciever_zip_code"
                                        placeholder="Zip *"
                                        v-model="tempData.reciever_data.zip_code" />
                                    <span v-if="recieverZipHasError" class="error has-text-danger is-size-7">
                                        <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                                        <span class="error-message">
                                            {{errors['reciever_data.zip_code'][0]}}
                                        </span>
                                    </span>
                                </div>
                            </form> -->
              ...
              <div class="column">
                <!-- <button class="button is-info w-200 m-b-30" @click.prevent="isImportingContacts = !isImportingContacts">{{isImportingContacts ? 'Select contacts' : 'Import contacts'}}</button> -->
        ...
        <!-- <b-modal :active.sync="isModalAddressListsActive" :width="550" scroll="keep" :onCancel="closeAddressListModal">
          <div class="card">
            <div class="card-header">
              <p v-if="isCreatingAddressList" class="card-header-title">Create new {{tempData.sender_data.company}} list</p>
              <p v-else class="card-header-title">{{tempData.sender_data.company}} address lists</p>
            </div>
            <div class="card-content">
              <div v-if="isCreatingAddressList" class="new-address-list-form">
                <div class="field">
                  <input
                      type="text"
                      v-model="newListName"
                      placeholder="Address list name"
                      v-on:keyup.enter="createAddressList"
                      :class="[{ 'has-error': newAddressListNameHasErrors }]">
                  <span v-if="newAddressListNameHasErrors" class="error has-text-danger is-size-7">
                      <i class="mdi mdi-alert-circle-outline mdi-18px"></i>
                      <span class="error-message">
                          {{errorsAddressList['name'][0]}}
                      </span>
                  </span>
                </div>
              </div>
              ...
              <b-table
                  ...
                  hoverable
                  striped
                  :data="selected_company_address_lists"
                  :selected.sync="selected_address_list">

                  <template slot-scope="props">
                    <b-table-column field="name" label="Select address list or create new">
                        {{ props.row.name }} <span v-if="props.row.addresses.length" class="has-text-weight-light"><small>({{props.row.addresses.length}})</small></span>
                    </b-table-column>
                  </template>
              </b-table>
              ...
              <div class="level m-t-30">
                <div class="level-left"></div>
                <div class="level-right">
                  <template v-if="isCreatingAddressList">
                    <button class="button m-r-10" @click.prevent="cancelNewAddressListForm">
                      <span class="m-l-5">Cancel</span>
                    </button>
                    <button class="button is-info" @click.prevent="createAddressList">
                      <span class="m-l-5">Create</span>
                    </button>
                  </template>
                  <template v-else>
                    <button class="button is-link m-r-10" @click.prevent="isCreatingAddressList = true">
                      <b-icon icon="library-plus"></b-icon>
                      <span class="m-l-5">New list</span>
                    </button>
                    <button class="button is-info" :disabled="!selected_address_list" @click.prevent="addContactsToSelectedAddressList">
...
<script>
    export default {
        ...
        methods: {
            ...
            // addContactsToSelectedAddressList() {
            //     let formData = new FormData();
            //     formData.append('addresses', this.checked_csv_addresses);
            ...
            // createAddressList() {
            //     let formData = new FormData();
            //     formData.append('company_id', this.tempData.company_id);
            //     formData.append('name', this.newListName);

            //     axios.post( '/api/addresslists/create', formData)
            //     .then(response => {
            //       this.isCreatingAddressList = false;
            //       this.getCompanies(this.tempData.company_id);
            //       this.$snackbar.open({
            ...
            // },
            // cancelNewAddressListForm() {
            //     this.newListName = '';
            //     this.errorsAddressList = null,
            //     this.isCreatingAddressList = false;
            // },
            // changeUploadInput() {
            //     this.showUploadCsvFileButton = true;
            //     this.checked_csv_addresses = [];
            //     this.csv_addresses = null;
            // },
            uploadCsvFile(event) {
